...
const slides = [
  {
    ...
    text: "Zadzwoń i krótko opisz sprawę. Ustalimy, czy właściwa będzie mediacja rodzinna, karna, cywilna, gospodarcza albo online.",
  ...
  },
  {
    ...
    text: "Przeczytaj krótkie artykuły o kosztach mediacji, ugodzie, mediacji karnej, rodzinnej i pierwszym spotkaniu z mediatorem.",
